...
SerialESP8266wifi::SerialESP8266wifi(Stream &serialIn, Stream &serialOut) {
    _serialIn = &serialIn;
...
SerialESP8266wifi::SerialESP8266wifi(Stream &serialIn, Stream &serialOut, Stream &dbgSerial) {
    _serialIn = &serialIn;
    _serialOut = &serialOut;
//    _resetPin = resetPin;
